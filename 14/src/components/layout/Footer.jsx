...
const Footer = () => {
  return (
    <footer className="bg-[#2C1E16] text-[#EAE0D5] pt-16 border-t border-white/10 mt-12 relative overflow-hidden">
          ...
          <div className="lg:col-span-4 pr-0 lg:pr-8">
            <Link to="/" className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <span className="text-[8px] md:text-[10px] text-primary uppercase tracking-widest font-bold">Textile Retail Mall</span>
              </div>
            </Link>
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center text-[#EAE0D5] hover:bg-primary hover:border-primary hover:text-white transition-all"><Video className="w-3.5 h-3.5" /></a>
            </div>
          </div>
