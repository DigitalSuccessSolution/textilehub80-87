      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-4 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col justify-between items-start space-y-6">
            <div className="space-y-4 w-full">
              <div className="flex justify-between items-end border-b border-slate-50 pb-3">
                <h3 className="text-sm font-bold text-slate-900 capitalize tracking-wider">LATEST FROM BLOG</h3>
                <Link to="/blog" className="text-xs font-bold capitalize tracking-wider text-accent hover:underline">View All</Link>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div className="space-y-1">
                  <span className="text-sm text-slate-400">June 10, 2026</span>
              ...
              <div className="flex gap-4">
                ...
                <div className="space-y-1">
                  <span className="text-sm text-slate-400">May 28, 2026</span>
                  <h4 className="font-heading font-bold text-slate-800 text-xs leading-snug hover:text-accent cursor-pointer">
          ...
          <div className="lg:col-span-4 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col justify-between items-start space-y-6">
            <div className="space-y-4 w-full">
              <div className="flex justify-between items-end border-b border-slate-50 pb-3">
                <h3 className="text-sm font-bold text-slate-900 capitalize tracking-wider">CUSTOMER REVIEWS</h3>
                <Link to="/reviews" className="text-xs font-bold capitalize tracking-wider text-accent hover:underline">View All</Link>
              </div>
              ...
              <div className="space-y-4 pt-2">
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-sm text-slate-400 font-medium">Retailer - Jaipur</p>
                  </div>
          ...
          <div className="lg:col-span-4 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col justify-between items-start space-y-6">
            <div className="space-y-4 w-full">
              <div className="flex justify-between items-end border-b border-slate-50 pb-3">
                <h3 className="text-sm font-bold text-slate-900 capitalize tracking-wider">MEDIA GALLERY</h3>
                <Link to="/media-gallery" className="text-xs font-bold capitalize tracking-wider text-accent hover:underline">View All</Link>
              </div>
