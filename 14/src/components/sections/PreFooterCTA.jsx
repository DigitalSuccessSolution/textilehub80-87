        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch max-w-5xl mx-auto">
          ...
          <div className="lg:col-span-7 bg-white p-8 rounded-2xl border border-slate-100 shadow-sm flex flex-col justify-between items-start space-y-6">
            <div className="space-y-3">
              <span className="text-xs font-bold text-accent capitalize tracking-widest block">LET'S GROW TOGETHER</span>
            ...
            <Link 
              to="/trade-enquiry"
              className="inline-flex items-center gap-2 bg-primary hover:bg-primary/95 text-white font-bold py-3 px-6 rounded-md text-xs capitalize tracking-wider transition-colors duration-300"
            >
          ...
          <div className="lg:col-span-5 bg-primary text-primary-foreground p-8 rounded-2xl shadow-lg flex flex-col justify-between border border-primary/20">
            <div className="space-y-4">
              ...
              <div>
                <span className="text-xs font-bold text-accent tracking-[0.25em] capitalize block mb-1">Our Presence</span>
            ...
            <div className="border-t border-white/10 pt-4 mt-6">
              <Link 
                to="/contact"
                className="text-xs font-bold capitalize tracking-wider text-accent hover:text-white flex items-center gap-1 transition-colors"
              >
