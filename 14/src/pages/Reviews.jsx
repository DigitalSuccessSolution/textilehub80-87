...
const Reviews = () => {
  const reviews = [
    ...
    },
    {
      ...
      location: "Hyderabad",
      rating: 5,
      content: "As a premium boutique owner, consistency is key. Texmart's automated retail management system ensures we never run out of our bestsellers. Their dedicated account managers are incredibly responsive."
    },
    {
      id: 3,
      name: "Amit Singhania",
    ...
    },
    {
      ...
      location: "Mumbai",
      rating: 5,
      content: "The transition from traditional purchasing to Texmart's digital B2B portal was seamless. The interface is intuitive, and the transparency in pricing and GST breakdowns is highly appreciated."
    },
    {
      id: 5,
      ...
      location: "Chandigarh",
      rating: 5,
      content: "We source our entire winter suiting collection from Texmart. The 5-point quality check they emphasize is real; we have practically zero return rates from our end consumers due to fabric defects."
    },
    {
      id: 6,
      name: "Anita Bose",
    ...
    <div className="bg-background min-h-screen">
      ...
      <div className="container-custom pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {reviews.map((review) => (
            <div key={review.id} className="bg-white p-8 rounded-2xl shadow-sm border border-border flex flex-col relative group hover:shadow-xl transition-all duration-300">
