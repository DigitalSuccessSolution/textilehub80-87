  ...
  return (
    <div className="bg-background min-h-screen">
      ...
      <div className="container-custom pb-20">
        ...
        {/* Featured Post */}
        {featuredPost && (
          <Link to="/blog-post" className="group block bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all border border-border mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {regularPosts.map((post) => (
            <Link to="/blog-post" key={post.id} className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all border border-border flex flex-col">
