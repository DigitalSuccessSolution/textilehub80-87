                    ...
                    <div className="space-y-12 max-w-5xl mx-auto">
                        {members.map((m, idx) => {
                            ...
                            return (
                                <div
                                    key={m.name}
                                    className={`bg-white border border-brand-gold/10 p-6 sm:p-10 rounded-[2.5rem] shadow-md hover:border-brand-lavender/30 transition-all duration-300 flex flex-col md:flex-row items-center gap-8 text-left ${isEven ? '' : 'md:flex-row-reverse'
                                        }`}
                                >
