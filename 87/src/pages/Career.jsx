  ...
  return (
    <div className="min-h-screen bg-[#FAF6F2] text-[#182220] pb-24">
        ...
        <div className="max-w-[1600px] mx-auto relative flex flex-col md:flex-row md:items-end justify-between gap-8 z-10">
          ...
          <div className="max-w-md border-l border-[#C29E6B]/40 pl-6 py-2">
            <p className="text-stone-300 text-xs sm:text-sm font-sans font-light leading-relaxed">
              Build your path with India's premium retail textile network at Aurora Textile House. Explore open job positions below and connect directly with our HR team.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 sm:px-10 max-w-5xl mx-auto grid grid-cols-1 gap-12">
          ...
          <div className="space-y-4">
            {openings.map((job, idx) => {
              ...
              return (
                <div 
                  key={idx} 
                  className="bg-white rounded-[2rem] border border-stone-200 shadow-sm overflow-hidden hover:border-[#C29E6B] hover:shadow-lg transition-all duration-300"
                >
                  ...
                  >
                    ...
                    <div className="w-10 h-10 rounded-full bg-[#FAF6F2] border border-[#10211F]/10 flex items-center justify-center text-[#10211F] group-hover:bg-[#C29E6B] transition-colors shrink-0">
        ...
        <div className="bg-[#10211F] rounded-[2.5rem] p-8 sm:p-12 text-center text-white border border-white/5 relative overflow-hidden shadow-lg mt-4">
          <div 
