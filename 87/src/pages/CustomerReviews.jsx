      ...
      <section className="py-20 px-6 sm:px-12 max-w-5xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            <h2 className="font-serif text-xl text-[#10211F] uppercase tracking-wider mb-2">Client Feed</h2>
            {feed.map((rev, idx) => (
              <div key={idx} className="bg-white border border-stone-200 hover:border-[#C29E6B] rounded-[2rem] p-8 shadow-sm space-y-4 hover:shadow-lg transition-all duration-300 relative group">
                <div className="flex justify-between items-center">
                  <h4 className="font-serif text-sm font-bold text-[#10211F] uppercase tracking-wide group-hover:text-[#2C443E] transition-colors">{rev.name}</h4>
          ...
          <div className="lg:col-span-5 bg-white border border-[#10211F]/5 rounded-[2.5rem] p-8 shadow-xl text-left">
            <h2 className="font-serif text-xl text-[#10211F] uppercase tracking-wider mb-6">Write Review</h2>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 text-xs font-sans">
              <div className="space-y-2">
                <label className="block text-[10px] font-bold uppercase tracking-wider text-[#10211F]">Your Name</label>
                <input
                  type="text"
              ...
              <div className="space-y-2">
                <label className="block text-[10px] font-bold uppercase tracking-wider text-[#10211F]">Rating (Stars)</label>
                <select
              ...
              <div className="space-y-2">
                <label className="block text-[10px] font-bold uppercase tracking-wider text-[#10211F]">Review Comment</label>
                <textarea
                  rows={4}
              ...
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-2 bg-[#10211F] hover:bg-[#C29E6B] text-white py-3.5 rounded-full font-bold text-xs uppercase tracking-widest transition-all duration-300 cursor-pointer shadow-md font-sans"
              >
