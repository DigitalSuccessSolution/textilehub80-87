  ...
  return (
    <>
      ...
      >
        ...
        <span className="absolute left-full ml-3 bg-white text-primary text-xs font-semibold  tracking-wider px-3 py-2 rounded-md shadow-md opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none border border-border">
          B2B Support Chat
        </span>
      </button>
          ...
          >
            ...
            <div className="bg-primary text-primary-foreground p-4 flex items-center justify-between border-b border-white/10">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-heading font-bold  tracking-wider text-white">Live Support Desk</span>
              </div>
            ...
            <div className="p-3 bg-white border-t border-border space-y-1.5 max-h-28 overflow-y-auto">
              <p className="text-[10px] font-bold text-slate-400  tracking-wide">Common Enquiries:</p>
              {faqs.map((faq, idx) => (
                <button
                  key={idx}
