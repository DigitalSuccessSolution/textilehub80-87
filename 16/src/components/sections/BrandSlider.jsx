      ...
      <div className="container-custom space-y-8">
        ...
        <div className="text-center">
          <div className="inline-flex items-center gap-3 justify-center">
            ...
            <span className="text-[10px] font-bold text-accent uppercase tracking-widest">Our Partners</span>
            <span className="w-10 h-0.5 bg-accent"></span>
          </div>
          ...
          <div className="flex gap-6 shrink-0 items-center min-w-full animate-scroll">
            {[...brands, ...brands].map((brand, idx) => (
              ...
              >
                ...
                <span className="text-xs font-heading font-extrabold tracking-wider text-primary uppercase block text-center">
                  {brand.name}
                </span>
                <span className="text-[8px] text-muted-foreground uppercase font-semibold mt-1 tracking-wider text-center">
                  {brand.type}
                </span>
              </div>
            ))}
