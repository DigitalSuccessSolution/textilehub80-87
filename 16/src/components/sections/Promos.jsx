        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 items-stretch">
          ...
          <div className="lg:col-span-3 bg-primary text-white p-6 rounded-2xl shadow-lg flex flex-col justify-between items-start space-y-5 relative overflow-hidden group">
            ...
            <div className="space-y-2 relative z-10">
              <span className="text-[10px] font-bold text-accent  tracking-widest block">New Collection</span>
            ...
            <div className="w-full h-40 bg-white/5 rounded-t-full overflow-hidden relative z-10 shrink-0 border border-white/10">
              <img
                src="https://images.pexels.com/photos/15488394/pexels-photo-15488394.jpeg"
            ...
            <Link
              to="/products"
              className="text-xs font-bold  tracking-wider text-accent hover:text-white transition-colors flex items-center gap-1 w-full border-t border-white/10 pt-4 relative z-10"
            >
          ...
          <div className="lg:col-span-3 bg-card p-6 rounded-2xl border border-border shadow-sm flex flex-col justify-between items-start space-y-5">
            <div className="space-y-3">
              <div className="space-y-1">
                <span className="text-[10px] font-bold text-accent  tracking-widest block">Quality Looms</span>
            ...
            <div className="w-full h-24 bg-muted rounded-xl overflow-hidden shrink-0">
              <img
                src="https://images.pexels.com/photos/36634904/pexels-photo-36634904.jpeg"
                alt="Fabrics Stack"
          ...
          <div className="lg:col-span-3 bg-accent/8 border border-accent/20 p-6 rounded-2xl flex flex-col justify-between items-start space-y-5 relative overflow-hidden group">
            <div className="space-y-2">
              <span className="text-[10px] font-bold text-accent  tracking-widest block">For Retailers</span>
            ...
            <div className="w-full h-28 bg-muted rounded-xl overflow-hidden shrink-0">
              <img
                src="https://images.pexels.com/photos/19511772/pexels-photo-19511772.jpeg"
            ...
            <Link
              to="/trade-enquiry"
              className="text-xs font-bold  tracking-wider text-foreground hover:text-accent transition-colors flex items-center gap-1 w-full border-t border-border/60 pt-4"
            >
          ...
          <div className="lg:col-span-3 flex flex-col gap-4">
            {[
              ...
              <div key={i} className="bg-card p-4 rounded-xl border border-border shadow-sm flex items-center justify-between gap-4 hover:border-accent/30 hover:shadow-md transition-all duration-300">
                <div className="space-y-1">
                  <h5 className="font-heading font-bold text-foreground text-xs  tracking-wider">{item.title}</h5>
                  <p className="text-[10px] text-muted-foreground leading-normal max-w-[150px] font-light">{item.desc}</p>
                  <Link to={item.path} className="text-[9px] font-bold text-accent hover:underline  tracking-wider block pt-0.5">{item.cta} →</Link>
                </div>
