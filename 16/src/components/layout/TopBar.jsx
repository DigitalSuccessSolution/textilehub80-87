...
const TopBar = () => {
  return (
    <div className="bg-primary text-white/80 py-2.5 hidden lg:block border-b border-white/10">
      <div className="container-custom flex justify-between items-center text-[10px] font-bold tracking-widest uppercase">
