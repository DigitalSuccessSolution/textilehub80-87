    ...
    <div className="bg-background min-h-screen">
      ...
      <div className="relative py-20 lg:py-32 overflow-hidden border-b border-border">
        ...
        <div className="container-custom relative z-10 text-center">
          <h1 className="font-heading text-4xl lg:text-6xl font-bold text-white mb-4">About Aurora Textile Mall</h1>
          <p className="text-white/80 max-w-2xl mx-auto text-sm lg:text-base font-light">
            A Legacy of Textile Excellence since 1999. We bridge the gap between master weavers, modern mills, and discerning retailers across India.
          </p>
        </div>
      </div>
      ...
      <section className="container-custom py-24 text-center">
        <h2 className="font-heading text-3xl md:text-5xl font-medium text-primary mb-6">Join the Aurora Network</h2>
