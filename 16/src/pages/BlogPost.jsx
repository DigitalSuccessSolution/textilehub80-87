  ...
  return (
    <div className="bg-background min-h-screen pt-24 pb-20">
      ...
      <div className="container-custom mb-8">
        <RouterLink to="/blog" className="inline-flex items-center gap-2 text-[10px] font-bold  tracking-widest text-muted-foreground hover:text-primary transition-colors">
      ...
      <article className="container-custom max-w-4xl">
        ...
        <header className="text-center mb-12">
          <div className="flex items-center justify-center gap-4 text-[10px] font-bold  tracking-widest text-muted-foreground mb-6">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <div className="text-left">
              ...
              <span className="block text-[10px]  tracking-widest text-muted-foreground font-bold">Textile Historian & Analyst</span>
            </div>
          </div>
        </header>
        ...
        <div className="max-w-3xl mx-auto mt-16 pt-8 border-t border-border flex flex-col sm:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <div className="flex gap-2">
              <span className="bg-muted px-3 py-1 rounded-full text-[10px] font-bold  tracking-widest text-primary">Handloom</span>
              <span className="bg-muted px-3 py-1 rounded-full text-[10px] font-bold  tracking-widest text-primary">Retail</span>
              <span className="bg-muted px-3 py-1 rounded-full text-[10px] font-bold  tracking-widest text-primary">Trends</span>
            </div>
          </div>
          
          <div className="flex items-center gap-4">
            <span className="text-[10px] font-bold  tracking-widest text-muted-foreground">Share:</span>
            <div className="flex gap-2">
