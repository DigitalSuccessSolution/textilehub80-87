    ...
    <div className="bg-background min-h-screen">
      ...
      <div className="container-custom">
        ...
        <div className="relative rounded-2xl overflow-hidden shadow-2xl mb-20 border border-border">
          <div className="bg-card px-4 py-3 border-b border-border flex items-center gap-2">
            ...
            <div className="mx-auto bg-muted px-32 py-1 rounded-md text-[10px] text-muted-foreground font-medium flex items-center gap-2">
              <Lock className="w-3 h-3" /> https://rms.auroramall.com
            </div>
          </div>
          <div className="bg-muted p-8 md:p-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              {/* Sidebar */}
              <div className="bg-card rounded-xl shadow-sm border border-border p-6 hidden md:block">
                <div className="flex items-center gap-3 mb-8">
                  <div className="w-8 h-8 bg-accent text-white rounded-full flex items-center justify-center font-bold">A</div>
              ...
              <div className="md:col-span-3 space-y-6">
                ...
                <div className="bg-card h-48 rounded-xl shadow-sm border border-border flex items-center justify-center relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-card p-8 rounded-2xl shadow-sm border border-border hover:shadow-md hover:border-accent/20 transition-all group">
        ...
        <div className="mt-20 bg-primary text-primary-foreground rounded-2xl p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/70 text-sm font-light mb-8 max-w-lg mx-auto">
              Our RMS is available exclusively to certified Aurora partners. Contact your dedicated account manager for a demo.
            </p>
