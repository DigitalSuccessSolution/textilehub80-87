      ...
      <div className="container-custom">
        ...
        <div className="mt-20 bg-primary text-primary-foreground rounded-2xl p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <a href="/trade-enquiry" className="bg-white text-primary px-8 py-3.5 rounded-full text-[10px] font-bold  tracking-widest hover:bg-white/90 transition-all shadow-lg inline-flex items-center gap-2">
