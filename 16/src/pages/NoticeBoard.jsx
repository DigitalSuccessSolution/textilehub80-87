              ...
              <div key={notice.id} className="flex flex-col md:flex-row gap-6 group">
                ...
                <div className="flex items-center md:items-start gap-4 md:w-48 shrink-0">
                  ...
                  <div className="md:pt-3">
                    ...
                    <span className="text-[9px]  tracking-widest text-muted-foreground font-bold">{notice.type}</span>
                  </div>
                </div>

                {/* Content Card */}
                <div className="bg-card p-6 md:p-8 rounded-2xl shadow-sm border border-border flex-1 hover:shadow-md hover:border-accent/20 transition-all relative">
                  <div className="hidden md:block absolute top-6 -left-3 w-3 h-3 bg-card border-t border-l border-border transform -rotate-45"></div>
                  ...
                  <div className="mt-6 pt-4 border-t border-border flex justify-end">
                    <button className="text-[10px] font-bold  tracking-widest text-accent flex items-center gap-1 hover:text-primary transition-colors">
