      ...
      <div className="container-custom max-w-6xl pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            {/* Steps Progress */}
            <div className="bg-card p-6 rounded-2xl shadow-sm border border-border flex items-center justify-between overflow-x-auto hide-scrollbar">
              {[
            ...
            {/* Step Content Area */}
            <div className="bg-card p-8 md:p-12 rounded-2xl shadow-sm border border-border relative overflow-hidden">
