        ...
        <div className="flex flex-col lg:flex-row flex-1 border border-border rounded-[30px] overflow-hidden shadow-sm">
          ...
          <div className="lg:w-5/12 bg-primary text-primary-foreground p-8 md:p-16 flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="relative z-10">
              <span className="text-accent font-bold  tracking-[0.2em] text-[10px] mb-4 block">B2B Partnership</span>
          ...
          {/* Right Side - Form */}
          <div className="lg:w-7/12 bg-card p-8 md:p-16 flex items-center justify-center relative">
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold  tracking-widest text-muted-foreground">Contact Person *</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold  tracking-widest text-muted-foreground">Company Name *</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold  tracking-widest text-muted-foreground">Email Address *</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold  tracking-widest text-muted-foreground">Phone / WhatsApp *</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold  tracking-widest text-muted-foreground">GST/VAT Number (Optional)</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold  tracking-widest text-muted-foreground">Enquiry Type *</label>
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-bold  tracking-widest text-muted-foreground">Specific Requirements *</label>
                ...
                <button className="bg-primary text-white w-full py-4 rounded-full text-xs font-bold  tracking-widest hover:bg-primary/90 transition-all shadow-md flex justify-center items-center gap-2">
