      ...
      <div className="container-custom max-w-6xl pt-6">
        ...
        <div className="bg-card border border-border rounded-2xl shadow-sm overflow-hidden">
          <div className="flex border-b border-border bg-muted/30 overflow-x-auto hide-scrollbar">
            <button 
              className={`px-8 py-5 text-[10px] font-bold uppercase tracking-widest transition-colors whitespace-nowrap ${activeTab === 'live' ? 'border-b-2 border-primary text-primary bg-card' : 'text-muted-foreground hover:text-primary hover:bg-card/50'}`}
              onClick={() => setActiveTab('live')}
            >
              Live Lots
            </button>
            <button 
              className={`px-8 py-5 text-[10px] font-bold uppercase tracking-widest transition-colors whitespace-nowrap ${activeTab === 'upcoming' ? 'border-b-2 border-primary text-primary bg-card' : 'text-muted-foreground hover:text-primary hover:bg-card/50'}`}
              onClick={() => setActiveTab('upcoming')}
            >
              Upcoming
            </button>
            <button 
              className={`px-8 py-5 text-[10px] font-bold uppercase tracking-widest transition-colors whitespace-nowrap ${activeTab === 'closed' ? 'border-b-2 border-primary text-primary bg-card' : 'text-muted-foreground hover:text-primary hover:bg-card/50'}`}
