...
const Contact = () => {
    ...
    return (
        <div className="min-h-screen bg-[#FAF5F0] text-[#24151D]">
                ...
                <div className="max-w-[1600px] mx-auto relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-8">
                    <div className="space-y-5 text-left">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[9px] font-sans font-bold uppercase tracking-[0.35em] text-[#C29E6B]">Get In Touch</span>
                        </div>
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif text-white leading-[1.05] tracking-tight">
                            Contact Our<br />
                            <span className="text-[#C29E6B] font-light italic">Showroom</span>
                        </h1>
                        <p className="text-sm text-stone-300 font-light leading-relaxed max-w-lg">
                            We'd love to hear from you. Reach out for trade enquiries, wholesale pricing, or just to say hello.
                        </p>
                    </div>
                    <div className="flex flex-wrap gap-4">
                        {[['Mon–Sat', '10 AM – 8 PM'], ['+91 63537 78329', 'Call Us'], ['care@auroratextile.com', 'Email']].map(([v, l], i) => (
            ...
            <section className="py-16 md:py-24 px-4 sm:px-8">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <h2 className="text-2xl md:text-3xl font-serif text-[#2E081B] uppercase tracking-wide">
                            ...
                            return (
                                <div
                                    ...
                                    className={`flex flex-col justify-between p-7 rounded-3xl border transition-all duration-300 group ${
                                        ch.dark
                                            ? 'bg-[#2E081B] border-white/10 hover:border-[#C29E6B]/40 text-white'
                                            : 'bg-white border-stone-200 hover:border-[#C29E6B]'
                                    }`}
                                >
                                    <div>
                                        <div className="mb-5">
                                        ...
                                        <h3 className={`text-base font-serif uppercase tracking-wide mb-3 ${ch.dark ? 'text-white' : 'text-[#2E081B]'}`}>
                                            {ch.title}
                                        </h3>
                                        <p className={`text-xs font-sans font-semibold mb-2 break-all ${ch.dark ? 'text-white/80' : 'text-[#24151D]'}`}>
                                            {ch.value}
                                        </p>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        {infoCards.map(({ icon: Icon, label, lines }, idx) => (
                            ...
                            >
                                <div className="p-3 bg-[#2E081B] rounded-xl flex-shrink-0">
                                ...
                                <div>
                                    ...
                                    {lines.map((line, i) => (
                                        <p key={i} className={`font-sans ${i === 0 ? 'text-sm font-bold text-[#2E081B]' : 'text-xs text-stone-500'} leading-relaxed`}>
                                            {line}
                                        </p>
                                    ))}
                                </div>
            ...
            <section className="pb-24 px-4 sm:px-8">
                <div className="max-w-6xl mx-auto">
                    <div className="bg-[#2E081B] rounded-3xl px-8 py-14 md:py-16 text-center border border-white/5 relative overflow-hidden text-white shadow-xl">
                        <div
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <Link
                                    to="/trade-enquiry"
                                    className="px-8 py-4 bg-[#9C4B6E] hover:bg-[#803856] text-white text-[10px] font-bold uppercase tracking-[0.3em] transition-all duration-300 rounded-full shadow-md cursor-pointer"
                                >
