...
const Management = () => {
    ...
    const leaders = [
        { name: "Devendra Parekh", role: "Managing Director", desc: "Over 35 years of experience in the textile weaving and garment manufacturing sectors.", img: "https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=400&q=80" },
        { name: "Rajesh Parekh", role: "Director of Operations", desc: "Manages day-to-day showroom mechanics, supply chains, and customer relations.", img: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&q=80" }
    ];
