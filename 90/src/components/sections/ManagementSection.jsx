...
const ManagementSection = () => {
    ...
    const members = [
        { name: "Devendra Singh", role: "Managing Director", img: "https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=300&q=80" },
        { name: "Rajesh Pal", role: "Director of Operations", img: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=300&q=80" }
    ];
