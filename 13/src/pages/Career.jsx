    ...
    <div className="bg-background min-h-screen">
      ...
      <div className="relative py-16 lg:py-24 overflow-hidden border-b border-border mb-12">
        ...
        <div className="container-custom relative z-10 text-center">
          <h1 className="font-heading text-4xl lg:text-6xl font-bold text-white mb-4">Careers at Texmart</h1>
      ...
      <section id="open-positions" className="container-custom py-20">
        ...
        <div className="mt-12 bg-muted p-8 rounded-2xl border border-border text-center">
          ...
          <p className="text-xs text-muted-foreground font-light mb-4">Send your resume to <a href="mailto:careers@texmart.com" className="text-accent hover:underline">careers@texmart.com</a> and we'll keep you in mind for future roles.</p>
        </div>
      </section>
