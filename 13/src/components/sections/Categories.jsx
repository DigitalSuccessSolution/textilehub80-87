      ...
      <div className="container-custom space-y-10">
        ...
        <div className="text-center">
          <div className="inline-flex items-center gap-3 justify-center w-full">
            ...
            <h3 className="text-2xl md:text-3xl font-heading font-bold text-primary tracking-wider">Our Product Categories</h3>
            <span className="w-10 h-0.5 bg-[#0C6C3E]"></span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-5">
          {list.map((item, idx) => (
            ...
            >
              ...
              {/* Title label */}
              <span className="text-[11px] font-bold text-slate-700 group-hover:text-accent transition-colors leading-tight whitespace-normal h-10 flex items-center justify-center mt-3 text-center tracking-wide">
                {item.name}
              </span>
            </Link>
          ))}
