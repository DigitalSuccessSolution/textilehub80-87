    ...
    <div className="bg-background min-h-screen">
      ...
      <div className="flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 bg-primary p-12 md:p-24 flex flex-col justify-center text-primary-foreground min-h-[60vh]">
          <h1 className="font-heading text-3xl md:text-5xl font-bold mb-6 leading-tight">Weave Your Career.</h1>
              ...
              <div key={job.id} className="bg-white border border-slate-200 rounded-lg overflow-hidden shadow-sm">
                ...
                >
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-1 text-[10px] tracking-wider font-bold text-slate-400">
                      <span>{job.dept}</span>
                ...
                {openJob === job.id && (
                  <div className="px-6 pb-6 pt-2 border-t border-slate-100 bg-slate-50/50">
                    ...
                    <button className="bg-primary text-white px-6 py-3 text-xs font-bold tracking-wider hover:bg-accent transition-colors flex items-center gap-2">
